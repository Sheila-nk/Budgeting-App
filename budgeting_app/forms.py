    ...
    def validate_email(self, email):
        ...
        if user:
            raise ValidationError(
                "That email already exists. Please use another one or log in instead."
            )
...
class DepositForm(FlaskForm):
    deposit_category = SelectField(
        "Category",
        choices=["Paycheck", "Savings", "Bonus", "Interest", "Other", "Custom"],
